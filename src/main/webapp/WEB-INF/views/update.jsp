...
<body>
	<div class="row">
		...
		<div class="col-md-4">
			<div class="container">
				<form action="/updatedishName" method="post"
					onsubmit="return validate()" id="form">
					<h2>Dish Application</h2>
					<div class="form-group">
						<label>Select Dish :</label> <select name="dishId">
							<c:forEach var="customer" items="${Dish}">
								<option value="${customer.dishId}">${customer.dishName}</option>
							</c:forEach>
						</select>
					</div>
					<div class="form-group">
						<label>Rating</label> <input type="number"
							...
							id="rating" value="${dish.rating}">
					</div>
					<div class="form-group">
						<label for="branchName"> Dish Price:</label> <input type="text"
							class="form-control item" name="dishPrice" id="dishPrice"
